...
import "../styles/Yeti404.css";

// Registra el plugin
gsap.registerPlugin(MorphSVGPlugin);

const Yeti404 = () => {
  const yetiTLRef = useRef(null);
  const chatterTLRef = useRef(null);
      ...
      <div className="yeti-visual">
        ...
        <svg id="yetiSVG" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 470">
          ...
          <g id="yeti">
            ...
            <g id="armL">
              ...
              <path className="hlFur" id="hlHandL" fill="#FFF" d="M101.7 156.9c-5.8-7.2-16.1-9.9-25-5.7-5.9 2.8-9.9 8.1-11.3 14.1l-1-.9-6.2 4.2c5.5 18.1 19.3 25.4 30.4 21l1.2-9.1c-6 2.4-12.7-.7-14.9-6.8-1.9-5.5.8-11.8 6.1-14.1 4.9-2.2 10.4-.6 13.5 3.4 1.3 1.6 3.5 2.1 5.4 1.4 2.9-1.3 3.8-5 1.8-7.5z" />
        ...
        <svg id="lightSVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 470">
          ...
          <g id="light" style={{ visibility: 'hidden' }} transform="translate(122.2, 177.4)">
            <path filter="url(#white-glow)" fill="#F8FFE8" d="M0 0c-5.2-1.6-13.6 2.1-20.6 8.3-7.7 6.8-11.4 16.8-9.3 22.1L421 1683h1534V733L0 0z" />
            <path opacity="0.7" fill="#FFFFFF" d="M-20.6,8.3c-8.2,7.3-11.9,18.2-8.8,23.1c2.6,4.1,13.6-1.1,21.8-8.4s13.6-18.1,9.9-21.6 C-1.9,0,-10.2,3.8,-20.6,8.3z" />
          </g>
          <g id="four04">
